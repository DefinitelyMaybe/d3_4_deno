...
import { fitExtent, fitHeight, fitSize, fitWidth } from "./fit.js";
...
export default function () {
  var cache,
    ...
    lower48 = albers(),
    lower48Point,
    alaska = conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels(
      [55, 65],
    ),
    alaskaPoint, // EPSG:3338
    hawaii = conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels(
      [8, 18],
    ),
