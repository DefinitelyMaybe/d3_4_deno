 ...
 */
export function sum<T extends Numeric>(
 ...
 */
export function mean<T extends Numeric>(
  iterable: Iterable<T | undefined | null>,
): number | undefined;
/**
 * Return the mean of an array of numbers
 ...
 */
export function median<T extends Numeric>(
  iterable: Iterable<T | undefined | null>,
): number | undefined;
/**
 * Return the median of an array of numbers
 ...
 */
export function quantile<T extends Numeric>(
  iterable: Iterable<T | undefined | null>,
  p: number,
): number | undefined;
/**
 ...
 */
export function variance<T extends Numeric>(
  iterable: Iterable<T | undefined | null>,
): number | undefined;
/**
 * Returns an unbiased estimator of the population variance of the given iterable of numbers using Welford’s algorithm.
 ...
 */
export function deviation<T extends Numeric>(
  iterable: Iterable<T | undefined | null>,
): number | undefined;
/**
 ...
 */
export function leastIndex<T, U>(
  iterable: Iterable<T>,
  accessor: (a: T) => U,
): number | undefined;
 ...
 * If comparator is not specified, it defaults to ascending.
 */
export function greatestIndex<T, U>(
  iterable: Iterable<T>,
  accessor: (a: T) => U,
): number | undefined;
