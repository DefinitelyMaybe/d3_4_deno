...
export default function (locale) {
  var group = locale.grouping === undefined || locale.thousands === undefined
    ...
    currencyPrefix = locale.currency === undefined
      ? ""
      : locale.currency[0] + "",
    currencySuffix = locale.currency === undefined ? ""
    : locale.currency[1] + "",
    ...
    function format(value) {
      ...
      switch (align) {
        ...
        case "=":
          ...
          break;
        case "^":
          value = padding.slice(0, length = padding.length >> 1) + valuePrefix +
            value + valueSuffix + padding.slice(length);
          break;
        default:
